...
namespace TerraUI.Objects {
    public class UIItemSlot : UIObject {
        ...
        public UIItemSlot(Vector2 position, int size = 52, int context = ItemSlot.Context.EquipAccessory,
        ...
        public override void Update() {
            if(!PlayerInput.IgnoreMouseInterface) {
                bool intersectsTick = false;// MouseUtils.Rectangle.Intersects(tickRect) && HasTick();
        ...
        public override void Draw(SpriteBatch spriteBatch) {
            ...
            if(DrawAsNormalSlot) {
                ItemSlot.Draw(spriteBatch, ref item, (int)Context, RelativePosition, Color.AliceBlue);
            }
            else {
