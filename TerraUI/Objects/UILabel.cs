...
namespace TerraUI.Objects {
    public class UILabel : UIObjectBordered {
        ...
        public UILabel(Vector2 position, Vector2 size, string text, SpriteFont font, byte borderWidth = 0,
        ...
        public override void Draw(SpriteBatch spriteBatch) {
            ...
            if(BorderWidth > 0) {
                //   Terraria.Utils.DrawBorderStringFourWay(spriteBatch, (DynamicSpriteFont)Font, text, RelativePosition.X, RelativePosition.Y,
